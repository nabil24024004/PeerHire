...
import {
  ...
  Wallet, Settings, Bell, Search, LogOut, User, Pin, PinOff, Menu, X, Bookmark
} from "lucide-react";
...
export const DashboardLayout = ({ children, role }: DashboardLayoutProps) => {
  ...
  const freelancerMenuItems = [
    ...
    { icon: Bookmark, label: "Saved Jobs", path: "/freelancer/saved-jobs" },
  ...
  const menuItems = role === "freelancer" ? freelancerMenuItems : hirerMenuItems;
