...
export default function HirerSettings() {
  ...
  const handleSaveNotifications = async () => {
    // Notification preferences saved locally (no table)
    toast({
      title: "Success",
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Once you delete your account, there is no going back. All your data including tasks, messages, and payments will be permanently removed.
              </p>
              <AlertDialog>
                  ...
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="space-y-2">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-sm">
                        ...
                        <li>Remove your payment history</li>
                      </ul>
